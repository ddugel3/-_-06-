...
#define _DUTY_NEU 1330 // neutral position
//===================================================
...
#define _SERVO_SPEED 1000//150             //[3147]  서보 속도를 30으로 설정
...
void loop() {
  ...
  if (event_dist) {
    ...
    filtered_cali_dist = 100 + 300.0 / (300 - 68) * (filtered_dist - 68);
    error_curr = _DIST_TARGET - filtered_dist; // [3158] 목표값 에서 현재값을 뺀 값이 오차값
    //===============================================
    pterm = KP*error_curr;                  // P 제어
    //control = pterm;          
    //===============================================
    dterm = KD * (error_curr - error_prev); // PD 제어
    control = dterm + pterm;
    //===============================================
    /*/iterm += KI * error_curr;              // PID 제어
  ...
  if (event_serial) {
    ...
    */
    ...
    Serial.print(map(duty_curr,1000,2000,410,510));
    Serial.println(",Min:75,Low:150,dist_target:206,High:270,Max:315");
    //*/
